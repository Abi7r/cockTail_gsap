...
const newIndex=(index + allCocktails.length)%totalCocktails;
    setCurrentIndex(newIndex)}

  const getCocktailAt=(indexOffset)=>{
  return allCocktails[(indexOffset+totalCocktails+currentIndex)%totalCocktails]}
    ...
    <section id='menu' aria-labelledby='menu-heading'>
      ...
      <div className="content">
        <div className="arrows">
          ...
          </button> <button className='text-right' onClick={()=>gotoSlide(currentIndex+1)}>
