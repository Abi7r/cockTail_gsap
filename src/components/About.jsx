...
const About = () => {
  useGSAP(()=>{const titleSplit=SplitText.create('#about h2',{type:'words'})
    ...
    scrollTimeLine.from(titleSplit.words,{opacity:0,yPercent:100,ease:'expo.inOut',stagger:0.02,duration:1})
        ...
        <div className='content'>
          <div className='md:col-span-8'>
           <p className='badge'>Best Cocktails</p>
            <h2>Where every detail matters <span className='text-white'>-</span>from muddle to garninsh</h2>
